...
def ejecutar_preprocesamiento(data):
    ...
    validación de negocio, transformación y estandarización.
    """
    ...
    df_transformado, X = preparar_datos_modelo(
        productos_validos
    )

    X_modelo, scaler = ajustar_y_transformar(X)
